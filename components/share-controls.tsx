...
export function ShareControls({ tripId }: { tripId: string }) {
  ...
  return (
    <div className="space-y-3">
      ...
      {publicUrl ? (
        <div className="rounded-lg border border-border bg-muted p-3 text-xs">
          ...
          <div className="mt-1 flex items-center gap-2">
            <p className="flex-1 break-all text-muted-foreground">{publicUrl}</p>
            <button className="rounded-md border border-border bg-card p-1.5 text-muted-foreground hover:text-primary" onClick={() => copyText(publicUrl)} type="button">
      ...
      {groupUrl ? (
        <div className="rounded-lg border border-border bg-muted p-3 text-xs">
          <p className="font-semibold text-foreground">Group voting</p>
          <div className="mt-1 flex items-center gap-2">
            <p className="flex-1 break-all text-muted-foreground">{groupUrl}</p>
            <button className="rounded-md border border-border bg-card p-1.5 text-muted-foreground hover:text-primary" onClick={() => copyText(groupUrl)} type="button">
              <Copy className="h-3.5 w-3.5" />
            </button>
          </div>
        </div>
