      ...
      <section className="social-card overflow-hidden p-6">
        <div className="grid gap-6 lg:grid-cols-[1.15fr_0.85fr]">
          <div>
            ...
            <h1 className="mt-4 text-3xl font-extrabold tracking-tight text-slate-900">Create from social inspiration</h1>
          ...
          <div className="rounded-xl border border-slate-200 bg-slate-50 p-4 text-sm text-slate-600">
            <p className="font-semibold text-slate-800">Need more ideas first?</p>
            <p className="mt-1 text-xs leading-relaxed text-slate-500">
              Explore trending posts and save references before creating. Your saved destination context can be used here.
            </p>
            <Link
              href="/feed"
              className="mt-3 inline-flex min-h-10 items-center gap-2 rounded-lg border border-slate-200 bg-white px-3 py-2 text-xs font-bold text-slate-700 hover:border-primary hover:text-primary"
            >
